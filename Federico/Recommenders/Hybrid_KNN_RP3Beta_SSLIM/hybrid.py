...
class SSLIMRP3BetaKNNRecommender(BaseItemSimilarityMatrixRecommender):
    ...
    def fit(self, alpha_knn_rp3=0.3,
        ...
        # {'epochs': 1185, 'symmetric': True, 'lambda_i': 0.5521128824527225, 'lambda_j': 0.4441613206459943, 'learning_rate': 0.021739977360530308}
    ...
    def _compute_item_score(self,
        ...
        for i in range(len(user_id_array)):
            ...
            # elif interactions >= (self.interactions_threshold or 10):
