...
# Normalizzazione interna al recommender
...
################################### USER GROUP ######################################
"""
Recommender ottimizzato per users con poche "aperture" e tante visualizzazioni
"""
profile_length = np.ediff1d(sps.csr_matrix(URMo).indptr)
sorted_users = np.argsort(profile_length)
users_in_group = sorted_users[:2081*14]
...
recommender_input_args = SearchInputRecommenderArgs(
    CONSTRUCTOR_POSITIONAL_ARGS = [URMv_train,URMo,icm],     # For a CBF model simply put [URM_train, ICM_train]
...
recommender_input_args_last_test = SearchInputRecommenderArgs(
    CONSTRUCTOR_POSITIONAL_ARGS = [URMv_train_validation,URMo,icm],     
    CONSTRUCTOR_KEYWORD_ARGS = {},
    FIT_POSITIONAL_ARGS = [],
    FIT_KEYWORD_ARGS = {},
    EARLYSTOPPING_KEYWORD_ARGS = {},
...
hyperparameterSearch.search(recommender_input_args,
                       ...
                       output_file_name_root = "views_recommender", # How to call the files
